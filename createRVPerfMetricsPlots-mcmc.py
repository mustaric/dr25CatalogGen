...
def completenessAndReliability(opsdata,invdata,injdata,opsFgkWant,invFgkWant,injFgkWant,climrange,outname,figTitle,s=[0.0,1.0]):
    ...
    plt.subplot(222)
    #Plot completeness
    plotMPGridS(injdata,'Completeness\nAll INJ PC Rate',(climrange[1]/2,climrange[1]),s=s)
    ...
    plt.subplot(224)    
    #FGK Completeness
    plotMPGridS(injdata[injFgkWant],'FGK Completeness\nINJ PC Rate',(climrange[1]/2,climrange[1]),s=s)
